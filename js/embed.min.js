(() => {
    let n = "difyChatbotConfig", a = "dify-chatbot-bubble-button", c = "dify-chatbot-bubble-window", p = window[n], h = {
    ...
    <path d="M18 18L6 6M6 18L18 6" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      #${n.id} {
        ...
        background-color: var(--${n.id}-bg-color,rgb(239, 221, 21));
    ...
    } function d(e) { var t; "Escape" === e.key && (e = document.getElementById(c), t = document.getElementById(a), e) && "none" !== e.style.display && (e.style.display = "none", t.querySelector("div").innerHTML = h.open) } document.addEventListener("keydown", d), p?.dynamicScript ? e() : document.body.onload = e
})();
